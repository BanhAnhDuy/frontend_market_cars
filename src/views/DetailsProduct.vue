...
<template>
    ...
    <div class="heading">
        ...
        <h2 class="text-dark text-center" style="padding-left: 20px;">CHI TIẾT MẪU XE</h2>
        </div>
    </div>
    <div class="wrapper">
    ...
    <div class="img_product col">
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
            ...
            <div class="info_product col" style="margin-left: 20px;">
                ...
                <span class="pricte text-danger">{{detailproduct.price}}VND</span>
                ...
                <div class="btn_product">   
                        <button type="submit" class="btn btn-danger" style="width:150px;" @click="getidcart()">Đặt Xe</button>
                     <router-link to="/">
