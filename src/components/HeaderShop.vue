...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
        <img src="https://thumbs.dreamstime.com/b/xe-logo-design-initial-letter-sci-fi-style-game-esport-technology-digital-community-business-e-sport-modern-italic-192979408.jpg" alt="Yame.vn" style="width: 66px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item border border-warning rounded-pill">
          <router-link to="/" class="nav-link " aria-current="page">
            Trang Chủ
          </router-link>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle border border-primary rounded-pill" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            MẪU XE HOT SEDAN
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#x">SEDAN 2022</a></li>
            <li><a class="dropdown-item" href="#x">SEDAN 2023</a></li>
          </ul>
        </li>
           <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle border border-danger rounded-pill" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            MẪU XE NĂNG ĐỘNG HATCH BACK
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#xx">XU HƯỚNG THỂ THAO</a></li>
            <li><a class="dropdown-item" href="#xx">XU HƯỚNG THỜI THƯỢNG</a></li>
           
            <li><a class="dropdown-item" href="#xx">XU HƯỚNG ĐƠN GIẢN</a></li>
          </ul>
        </li>
           <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle border border-success rounded-pill" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            MẪU XE HALF TRUCK MẠNH MẼ
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#xxx">BÁN TẢI 800KG</a></li>
            <li><a class="dropdown-item" href="#xxx">BÁN TẢI 900KG</a></li>
          </ul>
        </li>
      </ul>  
         ...
         <div class="wrapper_cart">
             <div class="cart_link" id="cart_link">
                <div class="card card-body bg-dark cart-info"> 
                    <div class="cart-list">
                        <h4 class="text-light">Kho xe của bạn</h4>
                  ...
                  <div class="footer-cart">
                          <span class="text-light">Có <span class="lenghtCart">{{getlengthcarts }}</span> sản phẩm trong kho xe </span>
                          <button class="btn btn-light" type="button" @click="gotocart">Vào xem xe</button>
                  </div>
            </div>
          </div>
